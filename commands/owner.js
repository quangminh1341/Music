...
module.exports = {
  ...
  run: async (client, interaction) => {
    try {
      const youtubeLink = 'https://discord.gg/MsNYkPPUcp';
      const InstagramLink = 'https://ayo.so/nzservice';
      const { EmbedBuilder } = require('discord.js')
        const embed = new EmbedBuilder()
          ...
          url: 'https://discord.gg/FUEHs7RCqz'
            ...
            .setDescription(`__**About me**__:\n\n ▶️ Hi I'm Z A I I K Y, Call for me!\n YouTube : ❤️ [Discord](${youtubeLink})\n Hướng Dẫn : 💙 [NZ Service](${InstagramLink})`)
            .setTimestamp();
